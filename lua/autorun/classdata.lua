...
Class[2]["description"] = "Juggernauts are equipped with heavily plated armor that has a 60% chance to absorb 1-5 points of damage. Juggernauts also gain a general 10% resistance to explosives. Juggernauts cannot be healed."
Class[2]["health"] = 100
Class[2]["armor"] = 100
Class[2]["stamina"] = 7
...
Class[6] = {}
Class[6]["name"] = "Zombie"
Class[6]["description"] = "Zombies gain +1 health and armor every 3 seconds and damage enemies based on distance in a 300 unit radius due to their toxic flesh. Zombies are also 200% weaker to headshots but 10% resistant to everywhere else. Zombies cannot heal."
Class[6]["health"] = 50
Class[6]["armor"] = 50
Class[6]["stamina"] = 15
...
Class[12]["description"] = "These soldiers have special armor that absorbs 25% of all explosive damage and reflects 10% of explosive damage."
Class[12]["health"] = 100
Class[12]["armor"] = 30
Class[12]["stamina"] = 10
