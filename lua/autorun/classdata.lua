...
Class[2]["description"] = "Juggernauts are equipped with heavily plated armor that absorbs 10-30 damage from the front. Juggernauts also gain a general 10% resistance to explosives. Juggernauts cannot be healed."
Class[2]["health"] = 100
Class[2]["armor"] = 100
Class[2]["stamina"] = 7
Class[2]["walkspeedmul"] = 0.50
Class[2]["runspeedmul"] = 0.50
Class[2]["jumpmul"] = 0.75
Class[2]["crouchmul"] = 1
Class[2]["fallmul"] = 4
Class[2]["perks"] = {"Necro","FlakJacketMinor","FrontDoor"}
Class[2]["color"] = Color(200,200,0,255)
Class[2]["icon"] = "models/Combine_Super_Soldier.mdl"

Class[3] = {}
Class[3]["name"] = "Assassin"
Class[3]["description"] = "Assassins use special ammunition that is 300% more lethal when used on areas such as the skull, but it's 50% weaker on all other areas. Assassins absorb 10-30 damage from behind."
Class[3]["health"] = 90
Class[3]["armor"] = 10
Class[3]["stamina"] = 25
Class[3]["walkspeedmul"] = 0.75
Class[3]["runspeedmul"] = 1.1
Class[3]["jumpmul"] = 1
Class[3]["crouchmul"] = 1.35
Class[3]["fallmul"] = 0.75
Class[3]["perks"] = {"HeadshotHunter","BackDoor"}
...
Class[4]["armor"] = 0
Class[4]["stamina"] = 40
Class[4]["walkspeedmul"] = 1.1
Class[4]["runspeedmul"] = 1.25
Class[4]["jumpmul"] = 1.25
Class[4]["crouchmul"] = 1
Class[4]["fallmul"] = 0.1
...
Class[5] = {}
Class[5]["name"] = "Grunt"
Class[5]["description"] = "Grunts are equipped with special Kevlar that absorbs 10% of damage from explosions and protects 25% of all damage done to the body, but not the head."
Class[5]["health"] = 100
Class[5]["armor"] = 0
Class[5]["stamina"] = 30
Class[5]["walkspeedmul"] = 0.90
Class[5]["runspeedmul"] = 0.90
Class[5]["jumpmul"] = 0.90
Class[5]["crouchmul"] = 1
Class[5]["fallmul"] = 1.1
...
Class[8]["description"] = "Soul Catchers trade life energy escaped from enemy wounds for bonus armor. For every 1 point of damage, 0.25 points of armor is added."
Class[8]["health"] = 75
Class[8]["armor"] = 0
Class[8]["stamina"] = 15
...
Class[9] = {}
Class[9]["name"] = "Void"
Class[9]["description"] = "Voids reflect 25% of damage done to them at the cost of 25% less base damage. Voids cannot relfect damage done by other methods of damage reflection. Voids cannot be healed."
Class[9]["health"] = 100
Class[9]["armor"] = 10
Class[9]["stamina"] = 15
...
Class[10]["description"] = "Phantoms have a 25% chance to completely dodge an attack. Phantoms cannot be healed."
Class[10]["health"] = 75
Class[10]["armor"] = 25
Class[10]["stamina"] = 25
Class[10]["walkspeedmul"] = 1
Class[10]["runspeedmul"] = 1.2
...
Class[12]["description"] = "These soldiers have special armor that absorbs half of all explosive damage and reflects 10% of explosive damage."
Class[12]["health"] = 100
Class[12]["armor"] = 30
Class[12]["stamina"] = 10
...
Class[13]["description"] = "Soldiers are equipped with Helmets and Kevlar, which block 25% of body damage and 20% of headshot damage respectively."
Class[13]["health"] = 100
Class[13]["armor"] = 15
Class[13]["stamina"] = 15
...
Class[14]["description"] = "25% of damage dealt to an enemy transfers to other enemies in a 1000 radius area."
Class[14]["health"] = 80
Class[14]["armor"] = 10
Class[14]["stamina"] = 15
...
Class[15]["description"] = "Gains the ability to grant critical strikes. Critical strikes stun your opponent for 0.25 seconds and do double damage. Every 2 points of base damage adds 1% chance to crit."
Class[15]["health"] = 100
Class[15]["armor"] = 0
Class[15]["stamina"] = 30
...
Class[17]["description"] = "Gains the cloak ability which drains 1 armor every 5 seconds. Cloak amount is based on movement speed. Each attack also steals armor based on 15% of damage dealt, Stacks up to 200 points of armor."
Class[17]["health"] = 20
Class[17]["armor"] = 50
Class[17]["stamina"] = 30
...
Class[18]["description"] = "For every point of health lost you gain 1% bonus damage resistance up to 25%. Survivors also have thick skin that has a 60% chance to absorb 1-5 damage."
Class[18]["health"] = 100
Class[18]["armor"] = 0
Class[18]["stamina"] = 25
Class[18]["walkspeedmul"] = 0.9
Class[18]["runspeedmul"] =0.9
Class[18]["jumpmul"] = 1
Class[18]["crouchmul"] = 1
Class[18]["fallmul"] = 1
Class[18]["perks"] = {"Survivor","Shield"}
Class[18]["color"] = Color(100,100,0,255)
Class[18]["icon"] = "models/monk.mdl"

Class[19] = {}
Class[19]["name"] = "Abandon"
Class[19]["description"] = "Damage dealt to Abandons have a 10% chance to convert damage into health."
Class[19]["health"] = 125
Class[19]["armor"] = 0
Class[19]["stamina"] = 20
...
Class[22] = {}
Class[22]["name"] = "Blood"
Class[22]["description"] = "Bloods inflict bleeding damage that drains health and stamina based on 50% of the damage dealt. Gains 10% bonus damage."
Class[22]["health"] = 60
Class[22]["armor"] = 0
Class[22]["stamina"] = 25
...
Class[24] = {}
Class[24]["name"] = "Leech"
Class[24]["description"] = "Leeches absorb 1 health per person per second in a 500 unit radius and adds it on to their health up to 200 health. Leeches cannot heal."
Class[24]["health"] = 75
Class[24]["armor"] = 0
Class[24]["stamina"] = 15
Class[24]["walkspeedmul"] = 0.9
Class[24]["runspeedmul"] = 0.9
Class[24]["jumpmul"] = 1
...
Class[25]["description"] = "Mysteries are difficult to shoot and even kill with their tendencies to confuse attackers who look at them. Mysteries also grant 20% evasion chance. Mysteries cannot heal."
Class[25]["health"] = 90
Class[25]["armor"] = 0
Class[25]["stamina"] = 15
Class[25]["walkspeedmul"] = 0.95
Class[25]["runspeedmul"] = 0.95
Class[25]["jumpmul"] = 1
...
Class[26]["armor"] = 0
Class[26]["stamina"] = 10
Class[26]["walkspeedmul"] = 0.65
Class[26]["runspeedmul"] = 0.65
Class[26]["jumpmul"] = 1
...
Class[28]["description"] = " Creed's Class. Gains the supercharged perk, gives insane amount of agility in sacrifice of damage over time. Health regenerates while standing still. Gains the double jump ability which allows the player to jump twice in the air. Cannot be healed by other means."
Class[28]["health"] = 100
Class[28]["armor"] = 0
Class[28]["stamina"] = 15
Class[28]["walkspeedmul"] = 1.6
Class[28]["runspeedmul"] = 1.6
Class[28]["jumpmul"] = 1.25
...
Class[31]["armor"] = 100
Class[31]["stamina"] = 15
Class[31]["walkspeedmul"] = 0.6
Class[31]["runspeedmul"] = 0.6
Class[31]["jumpmul"] = 0.75
Class[31]["crouchmul"] = 1
Class[31]["fallmul"] = 1.2
Class[31]["perks"] = {"Shatter","Necro"}
Class[31]["color"] = Color(100, 50, 255,255)
Class[31]["icon"] = "models/bots/heavy_boss/bot_heavy_boss.mdl"

Class[32] = {}
Class[32]["name"] = "Barter"
Class[32]["description"] = "You do 10 less damage, but it double damage after the damage reduction is calculated. For example if you do do 30 damage, you end up doing 40 damage because 30 minus 10 is 20, and double of 20 is 40."
Class[32]["health"] = 75
Class[32]["armor"] = 25
Class[32]["stamina"] = 20
Class[32]["walkspeedmul"] = 0.8
Class[32]["runspeedmul"] = 0.8
Class[32]["jumpmul"] = 0.9
