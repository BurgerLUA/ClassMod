...
Class[Number]["description"] = "Terrorists shoot 25% more faster and have double the clipsize, but do 50% less damage. Terrorists also have C4 explosives attached to their chest, which detonates upon death."
Class[Number]["health"] = 100
Class[Number]["armor"] = 0
Class[Number]["stamina"] = 15
...
Class[Number]["description"] = "Good for running around the map and being literally rambo. Gain 10% bonus damage at the cost of 30% incoming damage. Rambos have an endless clip. "
Class[Number]["health"] = 100
Class[Number]["armor"] = 0
Class[Number]["stamina"] = 15
