...
Number = Number + 1
Class[Number] = {}
Class[Number]["name"] = "Poisoner"
Class[Number]["description"] = "Poisoners deal poison damage at the cost of half damage. The poison deals half the amount stored plus 10 damage every 4 seconds, and removes said half from the stored damage until it's less than one. If the player who is poisoned has less than 10% of their max health, they die instantly."
Class[Number]["health"] = 100
Class[Number]["armor"] = 0
Class[Number]["stamina"] = 25
Class[Number]["walkspeedmul"] = 1
...
Class[Number]["crouchmul"] = 1.35
Class[Number]["fallmul"] = 0.75
Class[Number]["perks"] = {"Stagger"}
Class[Number]["color"] = Color(200,250,0,255)
Class[Number]["icon"] = "models/player/aphaztech.mdl"

Number = Number + 1
Class[Number] = {}
Class[Number]["name"] = "Zombie"
Class[Number]["description"] = "Class for people who want to have longer lives. Zombies gain +1 health 3 seconds up to 100 and damage enemies based on distance in a 300 unit radius due to their toxic flesh. Zombies are also 100% weaker to headshots but 10% resistant to everywhere else. Zombies also resist 1% of all damage per 1 point of lost health, up to 50% Zombies cannot heal."
...
Class[Number]["perks"] = {"DeadLife","BrainDamage","ArcLight","Necro","Survivor"}
...
Class[Number]["perks"] = {"Stunner","Forced"}
...
Class[Number]["description"] = "Great for having longer lives. Volts have a strong shield regeneration core that restores shields up to 100, but causes the user to take 100% bonus damage on shield depletion. Volts are also rigged to explode upon death."
Class[Number]["health"] = 100
Class[Number]["armor"] = 100
Class[Number]["stamina"] = 15
...
Class[Number]["perks"] = {"ArmorDependant","ArmorRegen","Snackbar"}
...
Class[Number]["description"] = "Counters snipers, great for sniping and/or camping. Gains the cloak ability which drains 1 armor every 5 seconds. Cloak amount is based on movement speed. Each attack also steals armor based on 15% of damage dealt, Stacks up to 200 points of armor. Gains 30% bonus damage. "
Class[Number]["health"] = 1
Class[Number]["armor"] = 100
Class[Number]["stamina"] = 30
Class[Number]["walkspeedmul"] = 0.5
...
Class[Number]["fallmul"] = 0
Class[Number]["perks"] = {"Cloak","ArmorSteal","DamageBuff"}
...
Class[Number]["description"] = "Good for mobility, great for shotgun lovers, not so good in combat. Has Double Clipsize, but 25% less damage. Take 4 damage per second if you move, but heal 4 health per second if you stand still. Supercharged also gives armor based on movement speed, up to a maximum of 200. Cannot be healed by other means."
Class[Number]["health"] = 100
Class[Number]["armor"] = 0
Class[Number]["stamina"] = 15
...
Class[Number]["crouchmul"] = 1
Class[Number]["fallmul"] = 1
Class[Number]["perks"] = {"Bleedout","Necro","SpeedShield","Cannon"}
