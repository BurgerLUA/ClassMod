...
Class[Number]["description"] = "Counters people trying to buttfuck you, good for people who are accurate. Assassins use special ammunition that is 300% more lethal when used on areas such as the skull, but it's 50% weaker on all other areas. Assassins absorb 10-30 damage from behind."
...
Class[Number]["perks"] = {"Splash","Bargin","GlobalKS"}
...
Class[Number]["description"] = "Great for having longer lives. Volts have a strong shield regeneration core that restores shields up to 100, but is highly experimental and will explode violently if you take damage while your shields are depleted. "
Class[Number]["health"] = 100
Class[Number]["armor"] = 100
Class[Number]["stamina"] = 15
...
Class[Number]["perks"] = {"Snackbar","ArmorDependant","ArmorRegen"}
...
Class[Number]["description"] = "Good for running around the map and being literally rambo. Gain 10% bonus damage at the cost of 30% incoming damage amplification. Rambos have an endless clip. "
Class[Number]["health"] = 100
Class[Number]["armor"] = 0
Class[Number]["stamina"] = 15
...
Class[Number]["description"] = "Good for mobility, great for shotgun lovers, not so good in combat. Gains the supercharged perk, gives insane amount of agility in sacrifice of damage over time as well as armor based on movement speed, up to a maximum of 200. Health regenerates while standing still. Cannot be healed by other means."
Class[Number]["health"] = 100
Class[Number]["armor"] = 0
Class[Number]["stamina"] = 15
